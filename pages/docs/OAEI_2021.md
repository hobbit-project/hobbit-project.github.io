...
In the diagrams we have excluded the extreme values for more comprehensible result. 
The excluded excluded values are: 
...
The results can be found in HOBBIT platform: [here](https://master.project-hobbit.eu/challenges/http:%2F%2Fw3id.org%2Fhobbit%2Fchallenges%23a670106e-a127-4bb2-b612-857210d453a6/experiments) (login as guest).
